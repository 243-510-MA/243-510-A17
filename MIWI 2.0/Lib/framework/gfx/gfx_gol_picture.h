...
*/
// *****************************************************************************
#define GFX_GOL_PictureControlImageGet(param_pObject)    \
                    (((GFX_GOL_PICTURECONTROL*)param_pObject)->pImage)
...
*/
// *****************************************************************************
#define GFX_GOL_PictureControlImageSet(param_pObject, param_pImage)    \
                    (((GFX_GOL_PICTURECONTROL*)param_pObject)->pImage = param_pImage)
