...
static uint8_t s_EventNotificationAction = WF_NOTIFY_ALL_EVENTS;
...
static void SetEventNotificationMask(uint8_t eventNotificationBitMask)
{
    s_EventNotificationAction = eventNotificationBitMask;
}
...
uint8_t GetEventNotificationMask(void)
{
    return s_EventNotificationAction;
}
                                  ...
                                  uint8_t dataReadAction)    /* true or false */
{
    ...
    if (dataReadAction == (uint8_t)true)
    {
        ...
        WaitForMgmtResponseAndReadData(WF_CA_GET_ELEMENT_SUBTYPE, elementDataLength,                   
            sizeof(tCAElementResponseHdr), p_elementData);                      
    }
    else
    {
...
/*******************************************************************************
  Function:
    void WF_SetReconnectMode(bool disableConnMgr)
