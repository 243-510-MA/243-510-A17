...
static bool isDisconnectSafe(void)
{
    ...
    WF_CMGetConnectionState(&profileIDState, &profileID);
...
void WF_CMGetConnectionState(uint8_t *p_state, uint8_t *p_currentCpId)
{
    ...
    WaitForMgmtResponseAndReadData(WF_CM_GET_CONNECTION_STATUS_SUBYTPE, sizeof(msgData),                 
        MGMT_RESP_1ST_DATA_BYTE_INDEX, msgData);                        
...
/*******************************************************************************
  Function:
    void WF_DeriveKey(uint8_t key_len, uint8_t *key, uint8_t ssid_len, uint8_t *ssid)
 ...
 *****************************************************************************/
void
WF_DeriveKey(uint8_t key_len, uint8_t *key, uint8_t ssid_len, uint8_t *ssid)
{
    uint8_t psk[32];
