...
static bool isHostScanSafe(void)
{
    uint8_t   profileID;
...
/*******************************************************************************
  ...
  Remarks:
    ...
    by setting WF_MODULE_CONNECTION_MANAGER == WF_DISABLED in drv_wifi_config.h
  *****************************************************************************/
uint16_t WF_Scan(uint8_t CpId)
{
    uint8_t   hdr[4];
...
/*******************************************************************************
  ...
  Description:
    ...
    MRF24WG0M supports up to max of 60 scan results (SSIDs).
                       ...
                       tWFScanResult  *p_scanResult)
{
    ...
    WaitForMgmtResponseAndReadData(WF_SCAN_GET_RESULTS_SUBTYPE, sizeof(tWFScanResult), 5, (uint8_t *)p_scanResult);              
