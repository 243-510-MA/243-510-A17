...
void WFEintHandler(void)
{
    ...
    if (RawMoveState.waitingForRawMoveCompleteInterrupt)
    {
        ...
        if (s_EintHostInt & (WF_HOST_INT_MASK_RAW_0_INT_0 | WF_HOST_INT_MASK_RAW_1_INT_0))
        {
            ...
            if ((s_EintHostInt & ~(WF_HOST_INT_MASK_RAW_0_INT_0 | WF_HOST_INT_MASK_RAW_1_INT_0)) == 0u)
            {
            ...
            else
            {
                ...
                s_HostIntSaved |= (s_EintHostInt & ~(WF_HOST_INT_MASK_RAW_0_INT_0 | WF_HOST_INT_MASK_RAW_1_INT_0));
