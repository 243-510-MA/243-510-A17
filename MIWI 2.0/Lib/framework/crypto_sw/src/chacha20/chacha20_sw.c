...
{  
    context->key.key32[13] = upper & 0x3f;
    context->key.key32[13] <<= 26;
    context->key.key32[13] |= (high >> 6) & 0x03ffffff;
    context->key.key32[12] = (high << 26) & 0xfc000000;
    context->key.key32[12] |= (low >> 6) & 0x03ffffff;
