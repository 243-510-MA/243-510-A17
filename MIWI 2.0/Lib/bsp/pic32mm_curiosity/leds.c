...
#define LED_LD3_RED_LAT     LATAbits.LATA3
#define LED_LD3_GREEN_LAT   LATBbits.LATB12
#define LED_LD3_BLUE_LAT    LATAbits.LATA2
#define LED_LD1_LAT         LATAbits.LATA0
#define LED_LD2_LAT         LATCbits.LATC9

#define LED_LD3_RED_TRIS    TRISAbits.TRISA3
#define LED_LD3_GREEN_TRIS  TRISBbits.TRISB12
#define LED_LD3_BLUE_TRIS   TRISAbits.TRISA2
#define LED_LD1_TRIS        TRISAbits.TRISA0
#define LED_LD2_TRIS        TRISCbits.TRISC9
