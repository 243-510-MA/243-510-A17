...
void OLED_PutChar(char inputCharacter)
{
        ...
        (inputCharacter <= '~') )
    {
        ...
        SH1101A_DataWrite(characters[(uint8_t)inputCharacter][0]);
        SH1101A_DataWrite(characters[(uint8_t)inputCharacter][1]);
        SH1101A_DataWrite(characters[(uint8_t)inputCharacter][2]);
        SH1101A_DataWrite(characters[(uint8_t)inputCharacter][3]);
        SH1101A_DataWrite(characters[(uint8_t)inputCharacter][4]);
        SH1101A_DataWrite(characters[(uint8_t)inputCharacter][5]);
