...
#define LED_D1_LAT      LATGbits.LATG8  //Set JP13 to PAD1
#define LED_D2_LAT      LATEbits.LATE9  //Set JP14 to PAD2
#define LED_D3_LAT      LATBbits.LATB5  //Set JP15 to PAD3
#define LED_D4_LAT      LATAbits.LATA7
//      LED_D6          //Power LED - indicates 3.3v supply

#define LED_D1_TRIS     TRISGbits.TRISG8    //overlaps with CTMU pad 1, and SW1
#define LED_D2_TRIS     TRISEbits.TRISE9    //overlaps with CTMU pad 2, and SW2
#define LED_D3_TRIS     TRISBbits.TRISB5    //overlaps with SW3 and potentiometer
#define LED_D4_TRIS     TRISAbits.TRISA7    //overlaps with A17 of SRAM

#define LED_D1_ANSEL    ANSGbits.ANSG8
#define LED_D2_ANSEL    ANSEbits.ANSE9
#define LED_D3_ANSEL    ANSBbits.ANSB5
#define LED_D4_ANSEL    ANSAbits.ANSA7
...
void LED_Enable(LED led)
{
    switch(led)
    {
        case LED_D1:
            LED_D1_TRIS = OUTPUT;
            LED_D1_ANSEL = DIGITAL;
            break;

        case LED_D2:
            LED_D2_TRIS = OUTPUT;
            LED_D2_ANSEL = DIGITAL;
            break;

        case LED_D3:
            LED_D3_TRIS = OUTPUT;
            LED_D3_ANSEL = DIGITAL;
            break;

        case LED_D4:
            LED_D4_TRIS = OUTPUT;
            LED_D4_ANSEL = DIGITAL;
            break;
