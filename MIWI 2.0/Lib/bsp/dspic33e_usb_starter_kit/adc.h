...
#define ADC_CHANNEL_POTENTIOMETER ADC_CHANNEL_NONE
...
#define ADC_ReadPercentage(channel) 50
...
#define ADC_Read10bit(channel) 512
...
#define ADC_ChannelEnable(channel)
...
#define ADC_SetConfiguration(configuration) true
