...
#define LED_D4_LAT      LATEbits.LATE1
#define LED_D5_LAT      LATEbits.LATE2
#define LED_D6_LAT      LATEbits.LATE3
#define LED_D7_LAT      LATEbits.LATE4
#define LED_D8_LAT      LATEbits.LATE5
#define LED_D9_LAT      LATEbits.LATE6
#define LED_D10_LAT     LATEbits.LATE7      //Overlaps with S5

#define LED_D3_TRIS     TRISEbits.TRISE0
#define LED_D4_TRIS     TRISEbits.TRISE1
#define LED_D5_TRIS     TRISEbits.TRISE2
#define LED_D6_TRIS     TRISEbits.TRISE3
#define LED_D7_TRIS     TRISEbits.TRISE4
#define LED_D8_TRIS     TRISEbits.TRISE5
#define LED_D9_TRIS     TRISEbits.TRISE6
#define LED_D10_TRIS    TRISEbits.TRISE7    //Overlaps with S5
