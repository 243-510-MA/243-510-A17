...
#define LED_D5_LAT      LATCbits.LATC4
#define LED_D6_LAT      LATCbits.LATC5
#define LED_D7_LAT      LATCbits.LATC6
#define LED_D8_LAT      LATCbits.LATC3

#define LED_D5_TRIS     TRISCbits.TRISC4
#define LED_D6_TRIS     TRISCbits.TRISC5
#define LED_D7_TRIS     TRISCbits.TRISC6
#define LED_D8_TRIS     TRISCbits.TRISC3
