...
#define LED_D3_LAT      LATGbits.LATG10  //check
#define LED_D4_LAT      LATGbits.LATG11
#define LED_D5_LAT      LATGbits.LATG2
#define LED_D6_LAT      LATGbits.LATG3
#define LED_D7_LAT      LATFbits.LATF4
#define LED_D8_LAT      LATFbits.LATF5
#define LED_D9_LAT      LATFbits.LATF6
#define LED_D10_LAT     LATFbits.LATF7      //Overlaps with S5

#define LED_D3_TRIS     TRISGbits.TRISG10
#define LED_D4_TRIS     TRISGbits.TRISG11
#define LED_D5_TRIS     TRISGbits.TRISG2
#define LED_D6_TRIS     TRISGbits.TRISG3
#define LED_D7_TRIS     TRISFbits.TRISF4
#define LED_D8_TRIS     TRISFbits.TRISF5
#define LED_D9_TRIS     TRISFbits.TRISF6
#define LED_D10_TRIS    TRISFbits.TRISF7    //Overlaps with S5
