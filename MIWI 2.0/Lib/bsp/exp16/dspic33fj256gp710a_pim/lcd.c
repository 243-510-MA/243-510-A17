...
#pragma message "This module requires a definition for the peripheral clock frequency.  Assuming 7.37MHz Fcy (7.37MHz Fosc).  Define value if this is not correct."
#endif
