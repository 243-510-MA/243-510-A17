...
#define LCD_D4_Enable()             TRISCbits.TRISC2 = 0;
#define LCD_D4_Write(value)         LATCbits.LATC2 = value;
#define LCD_D5_Enable()             TRISBbits.TRISB13 = 0;
#define LCD_D5_Write(value)         LATBbits.LATB13 = value;
#define LCD_D6_Enable()             TRISBbits.TRISB14 = 0;
#define LCD_D6_Write(value)         LATBbits.LATB14 = value;
#define LCD_D7_Enable()             TRISBbits.TRISB15 = 0;
#define LCD_D7_Write(value)         LATBbits.LATB15 = value;
