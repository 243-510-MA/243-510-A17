...
#define LED_D3_LAT      LATAbits.LATA8
#define LED_D4_LAT      LATAbits.LATA9
#define LED_D9_LAT      LATCbits.LATC4
#define LED_D10_LAT     LATCbits.LATC3      //Overlaps with S5

#define LED_D3_TRIS     TRISAbits.TRISA8
#define LED_D4_TRIS     TRISAbits.TRISA9
#define LED_D9_TRIS     TRISCbits.TRISC4
#define LED_D10_TRIS    TRISCbits.TRISC3    //Overlaps with S5
