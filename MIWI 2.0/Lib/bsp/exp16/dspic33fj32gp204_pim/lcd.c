...
/* This processor module does not have the LCD pins connected.  This file will
 * emulate the LCD API so a demo using the LCD can be run on this PIM.  The
 * print contents will be available in the "lcd" buffer and can be viewed
 * using debug mode ane the variable/watch windows. */
