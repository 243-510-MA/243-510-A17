...
/*** Button Definitions *********************************************/
//      S1  is MCLR button
#define S3_PORT  PORTCbits.RC9
#define S6_PORT  PORTCbits.RC8
#define S5_PORT  PORTBbits.RB13       //Overlaps with D10
#define S4_PORT  PORTBbits.RB7

#define S3_TRIS  TRISCbits.TRISC9
#define S6_TRIS  TRISCbits.TRISC8
#define S5_TRIS  TRISBbits.TRISB13
