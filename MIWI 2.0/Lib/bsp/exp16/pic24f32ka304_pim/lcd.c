...
#define LCD_RSSignal_Set()        LATBbits.LATB9 = 1  //set Register Select bit
#define LCD_RSSignal_Clear()      LATBbits.LATB9 = 0  //clear Register Select bit
#define LCD_RWSignal_Set()        LATBbits.LATB8 = 1  //set Read/Write bit
#define LCD_RWSignal_Clear()      LATBbits.LATB8 = 0  //clear Read/Write bit
#define LCD_EnableSignal_Set()    LATBbits.LATB7 = 1  //set Enable bit
#define LCD_EnableSignal_Clear()  LATBbits.LATB7 = 0  //clear Enable bit
#define LCD_RSSignal_Input()      TRISBbits.TRISB9 = 1 //set Register Select bit
#define LCD_RSSignal_Output()     TRISBbits.TRISB9 = 0 //clear Register Select bit
#define LCD_RWSignal_Input()      TRISBbits.TRISB8 = 1  //set Read/Write bit
#define LCD_RWSignal_Output()     TRISBbits.TRISB8 = 0  //clear Read/Write bit
#define LCD_EnableSignal_Input()  TRISBbits.TRISB7 = 1  //set Enable bit
#define LCD_EnableSignal_Output() TRISBbits.TRISB7 = 0  //clear Enable bit
...
bool LCD_Initialize ( void )
{
    ...
    LCD_DATA_TRIS &= 0x0F00 ;   //set RC0-7 as data output
...
{
    LCD_Wait ( delay ) ;
    int holder = ( LCD_DATA_LAT & 0xF00 ) >> 8 ;
    LCD_RWSignal_Clear ( ) ;
    LCD_RSSignal_Clear ( ) ;
    LCD_DATA_LAT = command | ( holder << 8 ) ;
