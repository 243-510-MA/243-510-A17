...
#define LED_D3_LAT      LATAbits.LATA9
#define LED_D4_LAT      LATAbits.LATA10
#define LED_D5_LAT      LATAbits.LATA11
#define LED_D6_LAT      LATCbits.LATC8
#define LED_D7_LAT      LATCbits.LATC9
#define LED_D8_LAT      LATBbits.LATB12
#define LED_D9_LAT      LATBbits.LATB2
#define LED_D10_LAT     LATBbits.LATB3      //Overlaps with S5

#define LED_D3_TRIS     TRISAbits.TRISA9
#define LED_D4_TRIS     TRISAbits.TRISA10
#define LED_D5_TRIS     TRISAbits.TRISA11
#define LED_D6_TRIS     TRISCbits.TRISC8
#define LED_D7_TRIS     TRISCbits.TRISC9
#define LED_D8_TRIS     TRISBbits.TRISB12
#define LED_D9_TRIS     TRISBbits.TRISB2
#define LED_D10_TRIS    TRISBbits.TRISB3    //Overlaps with S5
