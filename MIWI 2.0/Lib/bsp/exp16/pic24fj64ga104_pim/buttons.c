...
/*** Button Definitions *********************************************/
//      S1  is MCLR button
#define S3_PORT  PORTAbits.RA0      //Overlaps with D3
#define S6_PORT  PORTAbits.RA9       //Overlaps with D7
#define S5_PORT  PORTCbits.RC6       //Overlaps with D10
#define S4_PORT  PORTAbits.RA1       //Overlaps with D4

#define S3_TRIS  TRISAbits.TRISA0
#define S6_TRIS  TRISAbits.TRISA9
#define S5_TRIS  TRISCbits.TRISC6
#define S4_TRIS  TRISAbits.TRISA1
