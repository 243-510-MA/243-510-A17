...
#define LED_D4_LAT      LATCbits.LATC2
#define LED_D5_LAT      LATCbits.LATC3
#define LED_D6_LAT      LATCbits.LATC4

#define LED_D3_TRIS     TRISCbits.TRISC1
#define LED_D4_TRIS     TRISCbits.TRISC2
#define LED_D5_TRIS     TRISCbits.TRISC3
#define LED_D6_TRIS     TRISCbits.TRISC4
