...
#define LED_D3_LAT      LATAbits.LATA7
#define LED_D4_LAT      LATAbits.LATA8
#define LED_D5_LAT      LATAbits.LATA9
#define LED_D6_LAT      LATAbits.LATA10
#define LED_D7_LAT      /* not connected */
#define LED_D8_LAT      /* not connected */
#define LED_D9_LAT      /* not connected */
#define LED_D10_LAT     /* not connected */

#define LED_D3_TRIS     TRISAbits.TRISA7
#define LED_D4_TRIS     TRISAbits.TRISA8
#define LED_D5_TRIS     TRISAbits.TRISA9
#define LED_D6_TRIS     TRISAbits.TRISA10
#define LED_D7_TRIS     /* not connected */
#define LED_D8_TRIS     /* not connected */
#define LED_D9_TRIS     /* not connected */
#define LED_D10_TRIS    /* not connected */
