...
#define LCD_EnableSignal_Set()    LATBbits.LATB14 = 1  //set Enable bit
#define LCD_EnableSignal_Clear()  LATBbits.LATB14 = 0  //clear Enable bit
...
#define LCD_EnableSignal_Input()  TRISBbits.TRISB14 = 1  //set Enable bit
#define LCD_EnableSignal_Output() TRISBbits.TRISB14 = 0  //clear Enable bit
