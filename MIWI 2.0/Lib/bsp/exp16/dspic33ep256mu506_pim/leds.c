...
#define LED_D3_LAT      LATEbits.LATE14
#define LED_D4_LAT      LATEbits.LATE15
#define LED_D5_LAT      LATBbits.LATB6
#define LED_D6_LAT      LATBbits.LATB5      
#define LED_D10_LAT     LATCbits.LATC10      

#define LED_D3_TRIS     TRISEbits.TRISE14
#define LED_D4_TRIS     TRISEbits.TRISE15
#define LED_D5_TRIS     TRISBbits.TRISB6
#define LED_D6_TRIS     TRISBbits.TRISB5   
#define LED_D10_TRIS    TRISCbits.TRISC10   
