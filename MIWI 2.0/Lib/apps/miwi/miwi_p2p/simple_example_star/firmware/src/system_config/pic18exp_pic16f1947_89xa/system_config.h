...
#include "config_89xa.h"               //MiMAC API
    ...
    #define IRQ1_INT_PIN                PORTBbits.RB3     //PORTBbits.RB0      //PORTBbits.RB3
    #define IRQ1_INT_TRIS               TRISBbits.TRISB3  //TRISBbits.TRISB0   //TRISBbits.TRISB3

    #define PHY_IRQ1                IOCBFbits.IOCBF3   //INTCONbits.INTF     //INTCON3bits.INT3IF
    #define PHY_IRQ1_En             INTCONbits.IOCIE   //INTCONbits.INTE     //INTCON3bits.INT3IE
