...
void DemoOutput_Greeting(void)
{
            ...
            LCDDisplay((char *)"Simple P2P Demo  MRF49XA Node", 0, true);
        #endif
        #if defined(PROTOCOL_STAR)
            LCDDisplay((char *)"Simple STAR     MRF49XA Node", 0, true);
        #endif
        #if defined(PROTOCOL_MIWI)
            LCDDisplay((char *)"Simple MiWi Demo MRF49XA Node ", 0, true);
        #endif
        #if defined(PROTOCOL_MIWI_PRO)
            LCDDisplay((char *)"Simple MiWi PRO  MRF49XA Node ", 0, true);
        #endif
    #elif defined(MRF24J40)
        #if defined(PROTOCOL_P2P)
            LCDDisplay((char *)"Simple P2P Demo MRF24J40 Node ", 0, true);
        #endif
        #if defined(PROTOCOL_STAR)
            LCDDisplay((char *)"Simple STAR     MRF24J40 Node", 0, true);
        #endif
        #if defined(PROTOCOL_MIWI)
            LCDDisplay((char *)"Simple MiWi DemoMRF24J40 Node ", 0, true);
        #endif
        #if defined(PROTOCOL_MIWI_PRO)
            LCDDisplay((char *)"Simple MiWi PRO MRF24J40 Node ", 0, true);
        #endif
    #elif defined(MRF24XA)
        #if defined(PROTOCOL_P2P)
            LCDDisplay((char *)"Simple P2P Demo MRF24XA Node ", 0, true);
        #endif
        #if defined(PROTOCOL_STAR)
            LCDDisplay((char *)"Simple STAR     MRF24XA Node", 0, true);
        #endif
        #if defined(PROTOCOL_MIWI)
            LCDDisplay((char *)"Simple MiWi DemoMRF24XA Node ", 0, true);
        #endif
        #if defined(PROTOCOL_MIWI_PRO)
            LCDDisplay((char *)"Simple MiWi PRO MRF24XA Node ", 0, true);
        #endif
    #elif defined(MRF89XA)
        #if defined(PROTOCOL_P2P)
            LCDDisplay((char *)"Simple P2P Demo  MRF89XA Node ", 0, true);
        #endif
        #if defined(PROTOCOL_STAR)
            LCDDisplay((char *)"Simple STAR     MRF89XA Node", 0, true);
        #endif
        #if defined(PROTOCOL_MIWI)
            LCDDisplay((char *)"Simple MiWi Demo MRF89XA Node ", 0, true);
        #endif
        #if defined(PROTOCOL_MIWI_PRO)
...
{ 
    #if defined(EXPLORER16)
        LCDDisplay((char *)"RD6:New Network RD7:Freezer", 0, false);
    #elif defined(PIC18_EXPLORER)
        LCDDisplay((char *)"RB0:New Network RA5:Freezer", 0, false);
...
void STAR_DEMO_OPTIONS_MESSAGE(void)
{
    if (role == PanCoordinator)
    {
        #if defined(EXPLORER16)
            LCDDisplay((char *)"PC :RD6 or RD7  to Broadcast", 0, false);
        #elif defined(PIC18_EXPLORER)
            LCDDisplay((char *)"PC :RB0 or RA5  to Broadcast", 0, false);
        #elif defined(EIGHT_BIT_WIRELESS_BOARD)
    ...
    {
        #if defined(EXPLORER16)
            LCDDisplay((char *)"RD6 : Unicast   RD7 : Next Node", 0, false);
        #elif defined(PIC18_EXPLORER)
            LCDDisplay((char *)"RB0 : Unicast   RA5 : Next Node", 0, false);
        #elif defined(EIGHT_BIT_WIRELESS_BOARD)
