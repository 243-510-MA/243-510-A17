...
void Read_MAC_Address(void)
{
    ...
    else
    {
        ...
        {
            EEPROM_Read(&(myLongAddress[i]), EEPROM_MAC_ADDR+5-i, 1);
        }
    }
}


void EEPROM_Write (uint8_t *dest, uint8_t addr, uint8_t count)
{
