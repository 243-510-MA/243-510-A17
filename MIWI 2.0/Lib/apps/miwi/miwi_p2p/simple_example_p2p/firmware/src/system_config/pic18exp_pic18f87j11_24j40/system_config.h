...
#elif defined(__XC8) && !defined(_PIC18)
...
//  #define USE_PROGRAMMING_SPACE
    ...
    #else
        #define RFIF                    IOCBFbits.IOCBF3
        #define RFIE                    INTCONbits.IOCIE
    #endif
    ...
    #else
        #define PHY_IRQ1                IOCBFbits.IOCBF3
        #define PHY_IRQ1_En             INTCONbits.IOCIE
    #endif
    ...
    #define MAC_nCS_TRIS                 TRISCbits.TRISC2
    #define MAC_nCS                      LATCbits.LATC2
