...
#include "config_89xa.h"               //MiMAC API
    ...
    #define PHY_IRQ1                IOCBFbits.IOCBF3   //INTCON3bits.INT3IF
    #define PHY_IRQ1_En             INTCONbits.IOCIE   //INTCON3bits.INT3IE
    ...
    //#define PHY_IRQ0                  IOCBFbits.IOCBF4
    //#define PHY_IRQ0_En               INTCONbits.IOCIE
