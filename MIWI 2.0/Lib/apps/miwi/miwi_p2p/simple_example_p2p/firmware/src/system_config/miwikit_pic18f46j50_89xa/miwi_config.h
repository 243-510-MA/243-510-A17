...
#if !defined(PROTOCOL_P2P) && !defined(PROTOCOL_MIWI) && !defined(PROTOCOL_MIWI_PRO) &&!defined (PROTOCOL_STAR)
    #error "One Microchip proprietary protocol must be defined for the wireless application."
#endif

#if !defined(PROTOCOL_STAR)
    #if defined(ENABLE_LINK_STATUS)|| defined(ENABLE_PERIODIC_CONNECTIONTABLE_SHARE) || defined (MAKE_ENDDEVICE_PERMANENT)|| defined (ENABLE_APP_LAYER_ACK) 
